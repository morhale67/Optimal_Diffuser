...
def make_folder(p):
    folder_name = f"{p['model_name']}_TV_{p['TV']}_{p['data_name']}_bs_{p['batch_size']}_cr_{p['cr']}_nsamples{p['n_samples']}_picw_{p['pic_width']}_epochs_{p['epochs']}_wd_{p['weight_decay']}"
